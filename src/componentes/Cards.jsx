...
import { SucessIcon } from '../componentes/Icon';
    ...
    <section className='w-full py-[10rem] px-4 bg-gray-200 mt-[-5rem]'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='bg-white rounded-lg w-full shadow-xl flex flex-col my-4 pb-10'>
              ...
              <div className='text-left font-medium mx-8 text-sm'>
                
                  
                  
                    <div className='flex mt-2'>
                      <span className='w-4 pt-1'><SucessIcon /></span>
                      <p className='ml-1'>Brinde: Smartwatch Mormaii Life.</p>
                    </div>
                    
                    <div className='flex mt-1'>
                    <span className='w-4 pt-1'><SucessIcon /></span>
                      <p className='ml-1'>Acesso ilimitado ao Valor e O GLOBO pelo app Globo Mais.</p>
                    </div>
                  
                    <div className='flex mt-1'>
                    <span className='w-4 pt-1'><SucessIcon /></span>
                      <p className='ml-1'>Acesso ilimitado a Época Negócios, Globo Rural, PEGN e mais 9 revistas.</p>
                    </div>
                  
                    <div className='flex mt-1'>
                    <span className='w-4 pt-1'><SucessIcon /></span>
                      <p className='ml-1'>Edições impressas digitalizadas para ler no site, app ou offline.</p>
                    </div>
                  
                    <div className='flex mt-1'>
                    <span className='w-4 pt-1'><SucessIcon /></span>
                      <p className='ml-1'>As melhores coberturas sobre economia e finanças do país.</p>
                    </div>
                 
                    <div className='flex mt-1'>
                    <span className='w-4 pt-1'><SucessIcon /></span>
                      <p className='ml-1'>Clube O GLOBO com descontos em mais de 100 parceiros.</p>
                    </div>
          ...
          <div className='bg-white rounded-lg w-full shadow-xl flex flex-col my-4 pb-10'>
              ...
              <p className='text-7xl font-bold'><span className='text-2xl'>R$</span>19</p>
              ...
              <div className='flex mt-2'>
              <span className='w-4 pt-1'><SucessIcon /></span>
                      <p className='ml-1'>Acesso ilimitado ao site e app Valor e O GLOBO.</p>
                    </div>
                    
                    <div className='flex mt-1'>
                    <span className='w-4 pt-1'><SucessIcon /></span>
                      <p className='ml-1'>Edição impressa digitalizada para ler no site, app ou offline.</p>
                    </div>
                    ...
                    <div className='flex mt-1'>
                    <span className='w-4 pt-1'><SucessIcon /></span>
                      <p className='ml-1'>Mais de 20 revistas setoriais, anuários e suplementos.</p>
                    </div>
          ...
          <div className='bg-white rounded-lg w-full shadow-xl flex flex-col my-4 pb-10'>
            ...
            <button className='bg-[#00e500] rounded-lg my-1 mx-auto px-6 py-1 md:mb-7 text-[#002f3b] shadow-sm hover:shadow-lg hover:scale-105 duration-300'><a href="https://assinaturaglobo.globo.com/valor/endereco-entrega?oferta=valor-completo"><p className='font-bold uppercase'>Assine agora</p></a></button>
              ...
              <div className='text-left font-medium mx-8 text-sm'>             
                ...
                <div className='flex mt-2'>
                  <span className='w-4 pt-1'><SucessIcon /></span>
                  <p className='ml-1'>Jornal impresso de 2° a 6° feira.</p>
                </div>
                
                <div className='flex mt-1'>
                <span className='w-4 pt-1'><SucessIcon /></span>
                  <p className='ml-1'>Acesso ilimitado ao site e app Valor.</p>
                </div>
